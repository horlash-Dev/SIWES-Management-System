...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
				...
				<div class="">
					<div class="">
                        <div><h3 class="text-center m-2">All Registered Students</h3></div>
             ...
             <table class="table table-bordered">
                                ...
                                <?php 
                         foreach ($admin->details_student as $id  => $key) {   ?>
									<tr>
                                        ...
                                        <button type="submit" name="delete_data" class="btn btn-danger btn-md">Delete</button>
                                        </form>  
                                    </td> 
                                    </tr>
                         <?php } ?>
    ...
    <!-- completed details of student -->
    <div>
    <div><h3 class="text-center m-2">Students That Applied So Far..</h3></div>
    <div class="table-content">
							 <!-- /.theme-title -->
						<div class="table-responsive">
                        <table class="table table-bordered">
            ...
            <?php
     foreach ($admin->details_complete_student as $id  => $key) {   ?>
                <tr>
                    <td><?php echo ++$id; ?></td>
