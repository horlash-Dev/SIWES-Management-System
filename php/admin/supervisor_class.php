...
if (isset($_GET['s']) || isset($_GET['course']) || isset($_GET['name'])) {
    ...
    $dept= $_GET['course'];
    $name= $_GET['name'];
    $admin->admin_student_tags(hex2bin($ids));
}
?>
<!DOCTYPE html>
...
<body>
  ...
  <div class="list-group">
    ...
    <button type="button" class="list-group-item list-group-item-action">Department <span>: <b><?php echo $dept ?? null ?></b></span></button> 
					...
					<div class="">
                        <div><h3 class="text-center m-2 text-capitalize">students assigned to <?php echo $name ?? null ?> </h3></div>
             ...
             <table class="table table-bordered">
                                ...
                                <?php
                         foreach ($admin->admin_sign as $id  => $key) {   ?>
									<tr>
										<td><?php echo ++$id; ?></td>
                                        ...
                                        <button type="submit" name="remove_student" class="btn btn-success btn-md">REMOVE</button>
                                        </form>                                       
                                    </td> 
                                    </tr>
                         <?php } ?>
